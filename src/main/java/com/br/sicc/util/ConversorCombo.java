...
public final class ConversorCombo implements Converter {
	...
	/**
	 * Obtem o SelecItem de acordo com a opÃ§Ã£o selecionada pelo usuÃ¡rio
	 */
	...
	protected void addSelectItem(UISelectItem uiItem, List<SelectItem> items) {
		...
		if (value instanceof SelectItem) {
			...
			item = new SelectItem(itemValue == null ? "" : itemValue, itemLabel == null ? "" : itemLabel,
